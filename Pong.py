...
paddle_a.speed(0)  # set the animation speed for maximum
...
paddle_b.speed(0)  # set the animation speed for maximum
...
# Ball
ball = turtle.Turtle()
ball.speed(0)  # set the animation speed for maximum
ball.shape("square")
ball.color("white")
ball.penup()  # no drawing when moving
ball.goto(0, 0)
ball.dx = 2.5  # ball moves in 2px
ball.dy = -2.5
